...
class PDInfoCard extends Component {
  constructor(props) {
    super(props);
    const { upNumber, downNumber, upOrderNumber, downOrderNumber, delay } = props;
    if (delay) {
          ...
          <CardItem style={{ backgroundColor: Colors.row }}>
            <View style={styles.cardItemLeft}>
              <View>
                ...
                >
                  Địa chỉ: {this.props.upNumber} / {this.props.downNumber}
                </Text>
                <Text
                  style={Styles.normalColorStyle}
                >
                  Đơn: {this.props.upOrderNumber} / {this.props.downOrderNumber}
                </Text>
              </View>
            </View>
